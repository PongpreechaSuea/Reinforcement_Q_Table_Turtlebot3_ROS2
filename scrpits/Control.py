...
CONST_LINEAR_SPEED_FORWARD = 0.4  #0.08
CONST_ANGULAR_SPEED_FORWARD = 0.4  #0.0
CONST_LINEAR_SPEED_TURN = 0.4  #0.06
CONST_ANGULAR_SPEED_TURN = 0.4  #0.4
